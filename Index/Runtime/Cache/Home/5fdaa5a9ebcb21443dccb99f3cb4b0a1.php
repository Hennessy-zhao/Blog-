			...
			<div class="col-md-9" id="container">
				...
				<div class="row">
					<div class="col-md-12" id="vote">
						<form action="<?php echo U('Home/Votecontent/handle','','');?>" method="post">
							<table class="tab3">
								<?php if(is_array($data)): foreach($data as $key=>$data): ?><tr>
										<td align="left" style="width:15%">
										<span class="glyphicon glyphicon-star-empty"></span>&nbsp&nbsp<?php echo ($data["title"]); ?>&nbsp&nbsp
										</td>
										<td align="left" style="width:5%">
											<input type="radio" name="vote" value="<?php echo ($data["title"]); ?>">
										</td>
										<td align="left" colspan="5">
											<div class="progress progress-striped">
											   <div class="progress-bar progress-bar-success" role="progressbar" 
											       aria-valuemin="0" aria-valuemax="100" 	
											      style="width: <?php echo ($data["vote"]); ?>%;"><?php echo ($data["vote"]); ?>票
											   </div>
											</div>
										</td>
								...
								<tr>
									<td colspan="2">
										<center>
										<input type="submit" class="btn btn-success" value="投票" style="width:100px;height:40px;">
										</center>
									</td>
								</tr>
							</table>
